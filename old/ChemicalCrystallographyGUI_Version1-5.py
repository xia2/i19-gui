    ...
    def runXia2(self):
        ...
        if not datasetINPUT == "MULTIPLE":
            ...
            if self.prefix == "":
                ...
                return
            self.runXia2dataset(self.dataset, self.datasetPath)
        ###### multiple datasets ###########
...
####################################################
    def retranslateUi(self, MainWindow):
        ...
        self.menuFile_Open.setShortcut(_translate("MainWindow", "Ctrl+M"))
...
#Index_maxCell_lineEdit
            ...
            if varible.isChecked():
                ...
                if varible == self.HP_gasket_checkBox:
                    ...
                    if gasketType == "Tungsten":
                        options = options + " ice_rings.filter=True ice_rings.unit_cell=3.1652,3.1652,3.1652,90,90,90 ice_rings.space_group=Im-3m ice_rings.width=0.015"
                    if gasketType == "Steel":
                    # steel gaskets are often either Fe or Ni. The unit cell for Fe is given below. 
                        options = options + " ice_rings.filter=True ice_rings.unit_cell=2.87,2.87,2.87,90,90,90 ice_rings.space_group=Im-3m ice_rings.width=0.015"
    ...
    def retranslateUi(self, Xia2Options):
        ...
        self.HP_scanVarying_checkBox.setText(_translate("Xia2Options", "Scan varying"))
        self.HP_scanVarying_checkBox.setStatusTip(_translate("Xia2Options", "Allows models to vary during a scan."))
